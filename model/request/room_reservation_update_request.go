...
type RoomReservationUpdateRequest struct {
	Id      int64                 `validate:"required" json:"id" form:"id"`
	UserId  int64                 `validate:"required,existUser" json:"user_id" form:"user_id"`
	RoomId  int64                 `validate:"required,existRoom" json:"room_id" form:"room_id"`
	StartAt string                `validate:"required,datetime=2006-01-02 15:04:05,overlap" json:"start_at" form:"start_at"`
